...
\title{  AquaTux }
\name{Ameen Al Baz, David Biancolin, Victor Zhang, Ritchie Zhao}
...
\hypersetup{
    pdftitle={ AquaTux },
    pdfauthor={Ameen Al Baz, David Biancolin, Victor Zhang, Ritchie Zhao},
...
\Huge{AquaTux} \\
\vspace{.1in}
\large{ Ameen~Al~Baz, David~Biancolin, Victor~Zhang, Ritchie~Zhao }\\
