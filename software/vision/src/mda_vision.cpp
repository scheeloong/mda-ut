...
void MDA_VISION_MODULE_TEST:: calc_vci (int &vci) {
    vci = 1;
}
...
void MDA_VISION_MODULE_GATE:: calc_vci (int &vci) {
    vci = 1;
}
...
void MDA_VISION_MODULE_PATH:: calc_vci (int &vci) {
    vci = 1;
}
...
void MDA_VISION_MODULE_BUOY:: calc_vci (int &vci) {
    vci = 1;
}